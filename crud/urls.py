...
urlpatterns = [
    ...
    path('accounts/', include('allauth.urls'), name='button'),
    ...
    path('reset/<uidb64>/<token>/', auth_views.PasswordResetConfirmView.as_view(template_name='password.html'), name='password_reset_confirm'),
